  ...
  >
    <div class="flex items-center flex-no-shrink text-white mr-6">
      ...
      <span class="font-semibold text-xl tracking-tight"
        >Welcome to Employee Portal</span
      >
    </div>
    ...
    >
      <div class="grid grid-cols-12">
        <div class="pb-6 col-span-full md:pb-0 md:col-span-6">
          <a href="#" class="flex justify-center space-x-3 md:justify-start">
            <span class="self-center text-2xl font-semibold"
              >Made with &#10084; by Imran Lashari</span
            >
          </a>
        </div>
        <div class="col-span-6 text-center md:text-left md:col-span-3">
          ...
          <ul>
            <li>
              <a href="#" class="hover:dark:text-violet-400">Home</a>
            </li>
            <li>
              <a href="#" class="hover:dark:text-violet-400">About Us</a>
            </li>
            <li>
              <a href="#" class="hover:dark:text-violet-400">Contact Us</a>
            </li>
            <!---->
          </ul>
        </div>
        <div class="col-span-6 text-center md:text-left md:col-span-3">
          ...
          <ul>
            <li>
              <a href="#" class="hover:dark:text-violet-400">Email</a>
            </li>
            <!---->
          </ul>
        </div>
      ...
      <div class="grid justify-center pt-6 lg:justify-between">
        <div
          ...
          "
        >
          <span>CHAKOR © 2021 All rights reserved</span>
          <a href="#">
